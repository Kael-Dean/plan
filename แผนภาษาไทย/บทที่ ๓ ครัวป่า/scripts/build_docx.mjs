...
const PLAN_HOURS = "๑";
const UNIT_TITLE = "หน่วยการเรียนรู้ที่ ๓ เรื่อง ครัวป่า";
...
async function build() {
  ...
  const doc = new Document({
    creator: "Chapter 3 Builder",
    title: "หน่วยการเรียนรู้ที่ ๓ ครัวป่า",
    styles: {
      default: {
        document: {
  ...
  const outPath = join(__dirname, "..", "หน่วยการเรียนรู้ที่๓_ครัวป่า.docx");
